        ...
        <?php 
            ...
            while ($post = $result->fetch_assoc()) {
                ...
                <div id="post">
                    ...
                    <div id="postContent">
                        <div id="postText"><p><?php echo $post["Text"]; ?></p></div>
                        <div id='divPostImg'><img id="postImg" src="<?php echo $post["Image"]; ?>"></div>
                    </div>
                    <div id="postIcons">
                        <span style="margin-right: 1%;"><?php echo $post["Likes"]; ?></span>
                        <?php $LikeId = $post["Id"]; echo"<a href=\"DB/connections/addLike.php?id=$LikeId\"><img id=\"like\" src=\"assets/icons/like2.png\"></a>" ?>
                        <!-- <?php $saveId = $post["Id"]; echo"<a href=\"DB/connections/addSave.php?id=$saveId\"><img id=\"save\" src=\"assets/icons/save.png\"></a>" ?> -->
